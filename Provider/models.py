...
class ProviderClientTB(models.Model):
    ...
    Client = models.ForeignKey(ClientTB, to_field='Client',on_delete=models.PROTECT)
    Provider = models.ForeignKey(ProviderTB,to_field='Provider',on_delete=models.PROTECT)
    ConfirmationFlag = models.BooleanField(default=False)
